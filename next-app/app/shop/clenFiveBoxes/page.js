...
export const metadata = {
    ...
    description: 'Buy original Sopharma Clenbuterol online! Get 250 tabs with FREE and FAST shipping in Europe, and enjoy CASH ON DELIVERY payment method.',
    keywords: 'buy clenbuterol online, buy clenbuterol, buy clenbuterol sopharma, free shipping clenbuterol, cash on delivery clenbuterol, clenbuterol sopharma, clenbuterol kaufen, clenbuterol sopharma kaufen',
    openGraph: {
        title: 'clenSopharmaFiveBoxes',
        type: 'website',
        images: ['http://localhost:3000/clenSopharmaFiveBoxesWatermark.jpg'],
        url: 'http://localhost:3000/shop/clenFiveBoxes',
    },
    alternates: {
      canonical: 'http://localhost:3000/shop/clenFiveBoxes',
    }
};
